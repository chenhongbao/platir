...
public class Constants {
    ...
    public static final String FLAG_ORDER_OPEN = "order-open";
    public static final String FLAG_ORDER_CLOSE = "order-close";
    public static final String FLAG_ORDER_CLOSE_TODAY = "order-close-today";
    public static final String FLAG_ORDER_CLOSE_HISTORY = "order-close-history";
